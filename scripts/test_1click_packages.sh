...
declare -a PKG_IDS=("python_dev" "node_dev" "android_dev" "nginx_web" "openssh_server")
declare -a PKG_NAMES=("Python 3 Stack" "Node.js Stack" "Android Dev Tools" "NGINX Web Server" "OpenSSH Server")
declare -a PKG_CMDS=(
